...
save_ld_files <- function(ld_pairs_counts, ld_pairs_across_pops, ld_pairs_across_pops_sorted) {
...
LD_pairs <- function(pattern = "*_signLD_loci.txt", n_pops = 2) {
  ...
  save_ld_files(ld_pairs_counts, ld_pairs_across_pops, ld_pairs_across_pops_sorted)
